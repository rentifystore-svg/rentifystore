@echo off
title Rentify High-Fidelity App Demo - Deploy to GitHub
color 0A
echo.
echo ==========================================
echo    Rentify High-Fidelity App Demo
...
if exist ".git" (
    ...
    git commit -m "High-Fidelity Update: Complete code-based app demo recreation
